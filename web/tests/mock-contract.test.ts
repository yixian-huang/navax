...
const cases: Case[] = [
  ...
  { name: '提交主题目录审核', path: '/api/v1/me/themes/{themeId}/catalog-request', method: 'post', status: '201', url: '/api/v1/me/themes/thm_mock_priv_1/catalog-request', init: { method: 'POST' } },

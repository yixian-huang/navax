...
export default function SearchBar({
  ...
  return (
    <form onSubmit={handleSubmit} className="relative">
      <div
        className={cn(
          'flex items-center bg-background-50 transition-all duration-300 overflow-hidden',
          ...
          <div className="relative flex items-center pl-2 pr-2.5 flex-shrink-0">
            ...
            {engineOpen && (
              <>
                ...
                <div
                  className="absolute top-full right-0 mt-3 z-20 w-40 bg-background-50 rounded-xl shadow-overlay py-1.5 dropdown-enter"
                  role="listbox"
                  aria-label="选择搜索引擎"
                >
                  {engines.map(en => (
      ...
      {historyOpen && (
        <>
          ...
          <div
            className="absolute left-0 right-0 top-full mt-2 z-20 bg-background-50 rounded-xl shadow-overlay py-1.5"
            role="listbox"
            aria-label="最近搜索"
          >
